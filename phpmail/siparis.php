...
$mailtext='Sayın admin az önce '.$siteurl.' sitenizden sipariş formu gönderildi. Panele gidip detaylara erişebilirsiniz.';
...
$mail->Subject = "Siparis Talebi"; // Email konu başlığı
$mail->Body = $mailtext; // Mailin içeriği


if($mail->Send()) {

    Header( "Location:../siparis-onay.php?status=ok" );
