...
?>
<title><?php echo htmlspecialchars('Bayilik Başvurusu | ' . (isset($settingsprint['ayar_title']) ? $settingsprint['ayar_title'] : 'Site'), ENT_QUOTES, 'UTF-8'); ?></title>
