...
?>
<title><?php echo htmlspecialchars($settingsprint['ayar_title'] ?? 'Gizlilik Politikası', ENT_QUOTES, 'UTF-8'); ?></title>
</head>
<body class="wide no-page-loader">
<div id="wrapper" class="clearfix">
<?php include 'include/menu.php'; ?>
<?php legal_pages_render_public_shell('gizlilik', 'Gizlilik Politikası'); ?>
