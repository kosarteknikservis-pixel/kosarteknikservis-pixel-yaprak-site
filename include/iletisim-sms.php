...
?>
<meta http-equiv="refresh" content="0; URL=<?php echo $ayarcek['ayar_siteurl']; ?>iletisim?status=ok">

<?php

$sms_to = $ayarcek['ayar_tel'];
$message = 'Sayın admin az önce sitede iletişim formu ile mesaj gönderildi. Panele gidip detaylara erişebilirsiniz.';
